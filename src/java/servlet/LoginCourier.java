 ...
 * @author plksa
 */
@WebServlet(name = "LoginCourier", urlPatterns = {"/LoginCourier"})
public class LoginCourier extends HttpServlet {
    ...
    private void doAuthenticate(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
        ...
        try {
            ...
            if (isValid) {
                ...
                response.sendRedirect("Courier/home.jsp"); // Redirect to user home page
            } else {
                HttpSession session = request.getSession();
                session.setAttribute("errorMessage", "Invalid username/password or Courier incorrect!");
                response.sendRedirect("loginError.jsp"); // Redirect to error page with error message
            }
        } catch (SQLException ex) {
            Logger.getLogger(LoginUser.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void doLogin(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String targetURL = "LoginCourier.jsp";
